...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        taskManager.createSubTask("позвать гостей", "можно и через мессенджеры", 0, Status.IN_PROGRESS);
        ...
        taskManager.updateEpicTask(taskManager.epicTasksList.get(2), "Отпраздновать день рождения", "Устроить все как надо");
